    ...
    $.extend({
        ...
        function () {
            ...
            function appendToTable(table, cache) {
                ...
                /**************************************************************************************
                *************************** This is Jake Janak's Section ******************************
                **************************************************************************************/
                var jobsPerPage = $("#jobs-per-page :selected").val();
                var currentPage = document.getElementsByClassName("active");
                var page = parseInt($(currentPage).text());
                var rowsFiltered = document.querySelectorAll("tr:not(.filtered)");

                for (let i = 1; i <= rowsFiltered.length; i++) {
                    if (i > (page - 1) * jobsPerPage && i <= page * jobsPerPage) {
